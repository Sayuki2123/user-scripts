...
* #### 哈拉區顯示最近閱覽看板
  ...
  >
  > [安裝](https://github.com/Sayuki2123/user-scripts/raw/main/Bahamut/ForumLastBoard.user.js) /
  > [詳細資訊](Bahamut#哈拉區顯示最近閱覽看板)
...
* #### 搜尋條件的儲存數量限制解除
  ...
  > 解除搜尋條件的儲存數量限制
  >
  > [安裝](https://github.com/Sayuki2123/user-scripts/raw/main/BookwalkerJP/UnlimitedManualSearchHistory.user.js) /
  > [詳細資訊](BookwalkerJP#搜尋條件的儲存數量限制解除)
