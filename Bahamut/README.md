...
[ForumLastBoard.user.js](https://github.com/Sayuki2123/user-scripts/raw/main/Bahamut/ForumLastBoard.user.js)

#### 功能

* 在哈拉區新版首頁顯示舊版的最近閱覽看板區域
* 在哈拉區看板頁面的上方選單顯示最近閱覽看板列表
...
* 哈拉區新版首頁<br>
  ![舊版最近閱覽看板](assets/forum-last-board.jpg)

* 哈拉區上方看板選單<br>
  ![上方選單最近閱覽看板](assets/forum-last-board_topbar.jpg)

#### 更新日誌

* v1.1.1
  * 修正在哈拉區首頁的廣告出現後最近閱覽看板就會消失的問題
* v1.1.0
  * **腳本名稱變更**，哈拉區首頁最近閱覽看板 &rArr; 哈拉區顯示最近閱覽看板
  * 新增滑鼠經過各看板頁面上方選單的「哈拉區」按鈕時顯示最近閱覽看板
* v1.0.2
  * 修復 CSS、調整顯示的時間點
* v1.0.1
  * 修正無法使用 id 取得 aside 元素的錯誤和網址含有參數時不會顯示的問題
* v1.0.0
  * 初版
